				...
				<div class="col-md-12">
					...
					<div id="tnb_index">
						<ul>
							...
							<li><a href="/mypage"><label id="lnick"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!loggedInUser) {
        ...
        navList.innerHTML = `
            <ul>
                <li><a href="#"><i class="fas fa-sign-in-alt"></i> 문의사항</a></li>
                <li><a href="/mypage"><i class="fas fa-sign-in-alt"></i><label id="lnick" style="color: red;"></label></a> 님 어서오세요.</li>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive"
				...
				<ul class="navbar-nav ml-auto">
					<li class="nav-item dropdown megamenu-li"><a
						...
						aria-haspopup="true" aria-expanded="false">동취미</a>
						<ul class="dropdown-menu dropdown-menu-right"
							aria-labelledby="navbarDropdownPortfolio">
							<a class="dropdown-item ks4 fw4" href="/inte">소개</a>
					...
					<li class="nav-item dropdown megamenu-li"><a
						class="nav-link dropdown-toggle ks4 f15" href="#"
						id="navbarDropdownBlog" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false">Myclub</a>
						<ul class="dropdown-menu dropdown-menu-right"
							aria-labelledby="navbarDropdownPortfolio">
					...
					<li class="nav-item dropdown login"><a
						...
						<div class="dropdown-menu dropdown-menu-right"
							...
							<a class="dropdown-item" href="#">새글</a> <a class="dropdown-item"
								href="#">1:1문의</a> <a class="dropdown-item" href="/login">로그인</a>
